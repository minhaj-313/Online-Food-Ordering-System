...
<body>
    ...
    ?>
        ...
        <div class="container">
            ...
            ?>
            <div class="row">
                <div class="jumbotron p-3 mb-3 text-warning" style="display: flex;justify-content: center;width: 28%; border: 2px solid ;border-radius: 5px;margin: 0 auto; background-color: #000; ">
                    <div class="user-info">
                ...
                <div class="content-panel mb-3  text-dark" style="display: flex;justify-content: center;">
                    <div class=" p-3 bg-warning" style="border-radius: 5px;background-color: aliceblue;">
                        ...
                        <form action="partials/_manageProfile.php" method="post">
                            ...
                            <button type="submit" name="updateProfileDetail" class="btn custom-btn btn-1" style="margin-left: 220px; margin-right: 20px ;">Update</button>
                        </form>
                    </div>
                </div>
            </div>
