                    ...
                    <form action="partials/_orderManage.php" method="post" style="border-bottom: 2px solid #dee2e6;">
                        <div class="text-left my-2">
                            ...
                            <div class="row mx-2">
                                ...
                                <button type="button" class="btn btn-secondary ml-1" style="
    color: #fff;
    background-color: #ff0000;
    border-color: #0a5c00;
    font-size: 17px;
    border: none;
" data-container="body" data-toggle="popover" title="User Types" data-placement="bottom" data-html="true" data-content="0=Order Placed.<br> 1=Order Confirmed.<br> 2=Preparing your Order.<br> 3=Your order is on the way!<br> 4=Order Delivered.<br> 5=Order Denied.<br> 6=Order Cancelled.">
                                    <i class="fas fa-info"></i>
                                </button>
                            </div>
                        </div>
                        <input type="hidden" id="orderId" name="orderId" value="<?php echo $orderid; ?>">
                        <button type="submit" class="btn btn-success mb-2" style="
    color: #fff;
    background-color: #ff0000;
    border-color: #0a5c00;
    font-size: 17px;
